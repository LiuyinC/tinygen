...
class GPTService:
    ...
    def get_gpt_response(self, messages: List[Dict[str, Any]], response_format: str = "text") -> str:
    ...
    def notify_gpt_context_off(self) -> str:
    ...
    def suggest_code_improvements(self, prompt: str, repo_summary: str) -> Dict[str, str]:
        detailed_prompt = f"""
        ...
        return self.get_gpt_response(messages, response_format="json_object")

    def reflect_on_diff(self, diff: str, repo_summary: str) -> Dict[str, Any]:
